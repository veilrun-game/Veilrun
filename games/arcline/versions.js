/* VEILRUN — Arcline version manifest (default first).
   ...
   (first) entry; other builds are reachable from this dropdown. v1 stays default
   while v2 (kit + controller preview) is proven. To promote v2: move it to the top
   here AND repoint the combo `play` in js/data.js. */
window.VR_VERSIONS = [
  { id: "v1", name: "Arcline",                  url: "/games/arcline/index.html" },
  { id: "v2", name: "Plant & Power (preview)",  url: "/games/arcline-v2/index.html" }
];
(function () {
