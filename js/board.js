...
VEILRUN.board = {
  ...
  columns: [
    ...
    { name: "Up next", cards: [
      ...
      { id: "VR-65", t: "Profile v2: change password (email accounts)", who: "Claude", pri: "P3" },
    ...
    { name: "Done (recent)", cards: [
      { id: "★", t: "Google sign-in (one-tap) + full sign-out", who: "Both", pri: "" },
      { id: "★", t: "Profile page — display name, auto character, reorder your images", who: "Claude", pri: "" },
