...
VEILRUN.gameRefs = {
  ...
  orcsmustdie: { name: "Orcs Must Die! (series)", blurb: "Trap-and-defend. You fortify a route with traps, then hold the line in person as waves of orcs pour toward your rift — planning phase, then a combat phase where your own weapons cover what the traps miss. Co-op across the series.", dimension: "3D", platforms: ["PC", "PS5", "Xbox"], mechanics: ["base defense", "waves", "co-op", "traps"] },
  ...
  crimsondesert: { name: "Crimson Desert", blurb: "Open-world action adventure from Pearl Abyss, released 19 Mar 2026. Large-scale traversal and physical, grapple-heavy combat across a continent at war.", dimension: "3D", platforms: ["PC", "PS5", "Xbox"], mechanics: ["open world", "combat feel", "single player"] },
  reddeadredemption: { name: "Red Dead Redemption", blurb: "Rockstar's open-world western. A slow, weighty world where travel, hunting and incidental encounters carry as much of the game as the missions do — the pace is the design, not a cost.", dimension: "3D", platforms: ["PC", "PS5", "Xbox"], mechanics: ["open world", "story", "single player"] },
  ...
  golfwithyourfriends: { name: "Golf With Your Friends", blurb: "Up to twelve players putt through mini-golf courses at the same time, bumping each other off the green. Short holes, low stakes, easy to drop into.", dimension: "3D", platforms: ["PC", "PS5", "Xbox", "Switch"], mechanics: ["multiplayer", "party", "respects your time"] },
  uno: { name: "UNO", blurb: "The card game, online. Short rounds, house rules, and a chat window — the appeal is that it's something a whole group can play while talking about something else.", dimension: "2D", platforms: ["PC", "PS5", "Xbox", "Switch", "Mobile"], mechanics: ["multiplayer", "party", "respects your time"] },
  seaofthieves: { name: "Sea of Thieves", blurb: "Shared-world pirate co-op. A crew sails one ship together — someone steers, someone works the sails, someone patches holes below deck — chasing voyages while other real crews can find you at any time.", dimension: "3D", platforms: ["PC", "PS5", "Xbox"], mechanics: ["co-op", "open world", "shared roles", "PvPvE"] },
  commandandconquer: { name: "Command & Conquer (series)", blurb: "Real-time strategy. Harvest resources, build a base, produce an army and break the other side's base before they break yours — build order and economy as much as combat.", dimension: "2D", platforms: ["PC"], mechanics: ["base building", "strategy", "PvP"] },
  partyanimals: { name: "Party Animals", blurb: "Physics brawler. Wobbly puppies and kittens shove each other off ledges with deliberately unreliable ragdoll controls — the loose physics is the joke, not a flaw.", dimension: "3D", platforms: ["PC", "Xbox"], mechanics: ["multiplayer", "party", "physics"] },
  makeway: { name: "Make Way", blurb: "Build-and-race. Players lay down track pieces and hazards one at a time, then race across the track they collectively sabotaged. The building phase is the game.", dimension: "2D", platforms: ["PC", "Switch"], mechanics: ["multiplayer", "party", "building"] },
  ...
  plateup: { name: "PlateUp!", blurb: "Co-op kitchen roguelite. Run a restaurant across days that get harder, with permanent upgrades between runs — the pressure comes from coordinating who does what, not from reflexes.", dimension: "2D", platforms: ["PC", "PS5", "Xbox", "Switch"], mechanics: ["co-op", "roguelite", "progression", "shared roles"] },
  welcometoparadize: { name: "Welcome to ParadiZe", blurb: "Co-op zombie survival where you hack zombies into servants — they carry, fight and work your base while you build it up. Survival, base building and a light management layer.", dimension: "3D", platforms: ["PC", "PS5", "Xbox"], mechanics: ["co-op", "base building", "survival"] },
  allstarbrawl2: { name: "Nickelodeon All-Star Brawl 2", blurb: "Platform fighter in the Smash Bros mould — knock opponents off the stage rather than draining a health bar, with a Nickelodeon roster.", dimension: "2.5D", platforms: ["PC", "PS5", "Xbox", "Switch"], mechanics: ["multiplayer", "party", "combat feel"] },
  ...
  goatsimulator3: { name: "Goat Simulator 3", blurb: "Deliberately broken open-world slapstick. Co-op sandbox where the physics bugs are the content and the objectives are mostly excuses to cause trouble.", dimension: "3D", platforms: ["PC", "PS5", "Xbox"], mechanics: ["co-op", "party", "physics", "open world"] },
  rocketleague: { name: "Rocket League", blurb: "Car football. A tiny rule set with an enormous skill ceiling — aerials, dribbles and rotation come out of physics rather than abilities. Five-minute matches.", dimension: "3D", platforms: ["PC", "PS5", "Xbox", "Switch"], mechanics: ["multiplayer", "movement", "respects your time", "PvP"] },
  ...
  friendsvsfriends: { name: "Friends vs Friends", blurb: "Shooter with a deckbuilder bolted on. You bring a hand of cards into each round and play them mid-fight for weapons and effects — short matches, silly combos.", dimension: "3D", platforms: ["PC"], mechanics: ["multiplayer", "abilities", "PvP", "respects your time"] },
  thepluckysquire: { name: "The Plucky Squire", blurb: "Storybook adventure that jumps between 2D pages and the 3D desk the book sits on — the whole game is built on moving between the two, and puzzles use the transition itself.", dimension: "2.5D", platforms: ["PC", "PS5", "Xbox", "Switch"], mechanics: ["single player", "puzzle", "art & style"] },
  marvelrivals: { name: "Marvel Rivals", blurb: "6v6 hero shooter. Distinct kits per character, destructible environments, and team-up abilities that only trigger with specific character pairings — the closest commercial analogue to a synergy system.", dimension: "3D", platforms: ["PC", "PS5", "Xbox"], mechanics: ["abilities", "co-op squad", "PvP", "synergies"] },
  splitgate: { name: "Splitgate", blurb: "Arena shooter where every player can shoot portals — flanks and escapes come from portal placement, so the movement layer is entirely yours to invent. Its history is messy: the original's servers were shut down, and Splitgate 2 was pulled back to beta after a 2025 launch and relaunched as Splitgate: Arena Reloaded in December 2025.", dimension: "3D", platforms: ["PC", "PS5", "Xbox"], mechanics: ["movement", "PvP", "multiplayer"] },
  midnightmurderclub: { name: "Midnight Murder Club", blurb: "Hide-and-shoot in near-total darkness. Everyone has a pistol and a flashlight in a pitch-black mansion, and using your light to find someone also tells them exactly where you are. Voice chat is a mechanic.", dimension: "3D", platforms: ["PC", "PS5"], mechanics: ["multiplayer", "party", "PvP"] },
  diablo: { name: "Diablo (series)", blurb: "Isometric action RPG. Clear dungeons, collect loot, rebuild your character around what drops — the loop is build-craft and the endless numbers going up, playable co-op.", dimension: "3D", platforms: ["PC", "PS5", "Xbox", "Switch"], mechanics: ["abilities & builds", "progression", "co-op", "loot"] },
  helldivers2: { name: "Helldivers 2", blurb: "Co-op squad shooter. Four players drop into procedural missions, hold objectives against escalating waves, and extract. Friendly fire is always on, and stratagems are called in by typing directional codes under pressure.", dimension: "3D", platforms: ["PC", "PS5", "Xbox"], mechanics: ["co-op squad", "waves", "abilities", "survival"] },
  ...
  baldursgate3: { name: "Baldur's Gate 3", blurb: "Turn-based RPG on D&D rules, playable in co-op. The draw is that almost any plan works — the systems interact honestly enough that improvised solutions are usually supported rather than blocked.", dimension: "3D", platforms: ["PC", "PS5", "Xbox"], mechanics: ["co-op", "story", "abilities & builds"] },
  spiderman2: { name: "Marvel's Spider-Man 2", blurb: "Open-world superhero action. The web-swinging is the whole product — traversal that's enjoyable enough to be the reason you play, with combat and story built around it.", dimension: "3D", platforms: ["PS5"], mechanics: ["movement", "open world", "story", "single player"] },
  ridersrepublic: { name: "Riders Republic", blurb: "Open-world extreme sports playground. Bikes, skis, wingsuits and rockets across one shared map, with mass races and trick scoring.", dimension: "3D", platforms: ["PC", "PS5", "Xbox"], mechanics: ["movement", "multiplayer", "open world"] },
  nomanssky: { name: "No Man's Sky", blurb: "Procedural space survival. Explore, mine, build bases and fly between planets — notable as much for the years of free updates that turned a rough launch around as for the game itself.", dimension: "3D", platforms: ["PC", "PS5", "Xbox", "Switch"], mechanics: ["base building", "co-op", "open world", "survival"] },
  needforspeedheat: { name: "Need for Speed Heat", blurb: "Street racing with a day/night split — sanctioned races by day for money, illegal races by night for reputation, with police heat that follows you home. Deep visual customisation.", dimension: "3D", platforms: ["PC", "PS5", "Xbox"], mechanics: ["racing", "customisation", "progression"] },
  ...
  tonyhawkproskater: { name: "Tony Hawk's Pro Skater", blurb: "Trick-combo skating in two-minute runs. A short timer, a checklist of objectives per level, and a combo system that rewards linking everything together without touching the ground.", dimension: "3D", platforms: ["PC", "PS5", "Xbox", "Switch"], mechanics: ["movement", "respects your time", "progression"] },
  stray: { name: "Stray", blurb: "You're a cat in a dead neon city. Short, atmospheric, mostly traversal and light puzzles — carried by mood and animation rather than systems.", dimension: "3D", platforms: ["PC", "PS5", "Xbox", "Switch"], mechanics: ["single player", "art & style", "respects your time"] },
  cyberpunk2077: { name: "Cyberpunk 2077", blurb: "Open-world RPG in a dense vertical city. Build-driven — cyberware and skills let you play it as a hacker, a stealth build or a brawler — and a well-documented case of a disastrous launch repaired over years.", dimension: "3D", platforms: ["PC", "PS5", "Xbox"], mechanics: ["abilities & builds", "open world", "story", "art & style"] },
  dysmantle: { name: "Dysmantle", blurb: "Post-apocalyptic survival where the hook is that you can break absolutely everything down for materials. Open world, top-down, crafting and base upgrades driving the progression.", dimension: "2D", platforms: ["PC", "PS5", "Xbox", "Switch"], mechanics: ["survival", "base building", "progression", "open world"] },
  subnautica: { name: "Subnautica", blurb: "Underwater survival crafting. Scan what you find to unlock the means to go deeper, building habitats and submarines as you go — the pressure comes from the dark and the depth rather than from combat.", dimension: "3D", platforms: ["PC", "PS5", "Xbox", "Switch"], mechanics: ["survival", "base building", "single player", "progression"] },
  ...
  thewitcher3: { name: "The Witcher 3: Wild Hunt", blurb: "Open-world RPG. Its reputation rests on the side quests — the smaller stories are written as well as the main one, which is why people remember the world rather than the combat.", dimension: "3D", platforms: ["PC", "PS5", "Xbox", "Switch"], mechanics: ["story", "open world", "single player"] },
  eldenring: { name: "Elden Ring", blurb: "Open-world soulslike. Hard combat with readable rules, almost no direction, and discovery as the reward — you're trusted to go the wrong way and find something.", dimension: "3D", platforms: ["PC", "PS5", "Xbox"], mechanics: ["combat feel", "open world", "abilities & builds"] },
  ...
  stickfight: { name: "Stick Fight: The Game", blurb: "Physics brawler with stick figures. Up to four players, absurd weapons, levels that fall apart under you — rounds last seconds and nobody takes it seriously.", dimension: "2D", platforms: ["PC", "PS5", "Xbox", "Switch"], mechanics: ["multiplayer", "party", "physics", "respects your time"] },
  theclassroom: { name: "The Classroom (browser series)", blurb: "Browser point-and-click from the Flash era — cause trouble in a classroom without the teacher catching you, one small puzzle at a time. Nostalgia tier, and a fair reminder of how small a game can be and still be remembered. (Jordan to correct the details — this one's from memory, not a source.)", dimension: "2D", platforms: ["Browser"], mechanics: ["puzzle", "single player", "respects your time"] }
};
