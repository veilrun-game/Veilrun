...
VEILRUN.modes = [
  ...
  { id: "pair-levels", name: "2D Pair Levels", status: "prototyping", text: "Levels only clearable with a specific pair's combo. Purest synergy test. Playable: 'The Seam Gate' with Anvil + Latch — Latch flips between the two worlds, Anvil charges through cracked walls.", chars: "Pairs", play: "games/pair-level/index.html", gameId: "seam-gate", version: "v1",
    boardGroups: [
      { id: "v1", label: "v1 · Seam Gate", levels: [ { id: "seam-gate", label: "L1 · Seam Gate" }, { id: "seam-gate-2", label: "L2 · The Long Seam" }, { id: "seam-gate-3", label: "L3 · The Underseam" } ] },
...
VEILRUN.updates = [
  ...
  { date: "2026-07-28", title: "Level 3 is live — and Anvil learned to slam", text: "‘The Underseam’ adds a third level and a new Anvil move: while he's in the air, his ability crashes him straight down instead of charging. Some floors won't survive that. There's a faster way through this level than the gate gauntlet up top — but you'll have to find it. (Rumor is it's hiding somewhere you'd never think to look.) Fastest route wins the board.", cta: { label: "▶ Play Level 3", href: "games/pair-level/index.html" } },
