...
VEILRUN.modes = [
  ...
  { id: "pair-levels", name: "2D Pair Levels", status: "prototyping", text: "Levels only clearable with a specific pair's combo. Purest synergy test. Playable: 'The Seam Gate' with Anvil + Latch — Latch flips between the two worlds, Anvil charges through cracked walls.", chars: "Pairs", play: "games/pair-level/index.html" },
...
VEILRUN.updates = [
  { date: "2026-07-25", title: "Seam Gate controls feel better", text: "A few prototype fixes: Latch now trails behind Anvil during a charge (Anvil's the shield, not a scoop), you can slide your thumb between ◄ and ► to change direction instead of re-tapping, the ability button keeps a steady ✦ icon with the action name underneath, and the ‘← Lab’ link finally lands you back in the Lab (not the Hub)." },
