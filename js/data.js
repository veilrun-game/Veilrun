  ...
  { id: "pair-levels", name: "2D Pair Levels", status: "prototyping", text: "Levels only clearable with a specific pair's combo — the purest synergy test. Choose your characters, then run their levels: Anvil + Latch (flip the world & charge through walls) or Cinder + Vesper (stealth — cloak, gas, and the Dose combo).", chars: "Pairs", version: "v1",
    ...
    boardTree: [
      { id: "v1", label: "v1 (current)", combos: [
        { id: "anvil-latch", label: "Anvil + Latch", play: "games/pair-level/index.html", levels: [ { id: "seam-gate", label: "Level 1" }, { id: "seam-gate-2", label: "Level 2" }, { id: "seam-gate-3", label: "Level 3" } ] },
        { id: "cinder-vesper", label: "Cinder + Vesper", play: "games/shadow-run/index.html", levels: [ { id: "shadow-run", label: "Level 1" }, { id: "shadow-run-2", label: "Level 2" }, { id: "shadow-run-3", label: "Level 3" } ] },
        { id: "rook-wren", label: "Rook + Wren", play: "games/uplift/index.html", levels: [ { id: "uplift", label: "Level 1" }, { id: "uplift-2", label: "Level 2" }, { id: "uplift-3", label: "Level 3" } ] },
        { id: "temper-citrine", label: "Temper + Citrine", play: "games/arcline/index.html", levels: [ { id: "arcline", label: "Level 1" }, { id: "arcline-2", label: "Level 2" }, { id: "arcline-3", label: "Level 3" } ] },
        { id: "magpie-babel", label: "Magpie + Babel", play: "games/runeway/index.html", levels: [ { id: "runeway", label: "Level 1" }, { id: "runeway-2", label: "Level 2" }, { id: "runeway-2b", label: "Level 2-2" }, { id: "runeway-3", label: "Level 3" } ] }
      ] },
      { id: "v2", label: "v2 (preview)", combos: [
        { id: "anvil-latch", label: "Anvil + Latch · Shield the Keystone", play: "games/pair-level-v2/index.html", levels: [ { id: "pair-level-v2", label: "Slice 1 — Shield the Keystone" } ] },
        { id: "temper-citrine", label: "Temper + Citrine · Plant & Power", play: "games/arcline-v2/index.html", levels: [ { id: "arcline-v2", label: "Slice 1 — Plant & Power" } ] },
        { id: "rook-wren", label: "Rook + Wren · Brains & Body", play: "games/uplift-v2/index.html", levels: [ { id: "uplift-v2", label: "Slice 1 — Brains & Body" } ] },
        { id: "cinder-vesper", label: "Cinder + Vesper · Quiet Catering", play: "games/shadow-run-v2/index.html", levels: [ { id: "shadow-run-v2", label: "Slice 1 — Quiet Catering" } ] },
        { id: "magpie-babel", label: "Magpie + Babel · Cross the Seam", play: "games/runeway-v2/index.html", levels: [ { id: "runeway-v2", label: "Slice 1 — Cross the Seam" } ] }
      ] },
      { id: "v0", label: "v0 (legacy)", combos: [
        { id: "anvil-latch", label: "Anvil + Latch · Foundry Gate", play: "games/pair-level/versions/v0/index.html", levels: [ { id: "foundry-gate", label: "Level 1" } ] }
      ] }
    ] },
  { id: "story-cyoa", name: "Story Chapters (Choose-Your-Adventure)", status: "prototyping", text: "Single-character branching stories, Lifeline/Reigns-style. You guide a lead through one self-contained chapter; who you bring and the calls you make decide how it ends — many ways to win, many ways to fail. Chapter 1: Rook Signal (guide the crew through a thinning pocket to reach Wren). More characters coming.", chars: "Solo lead + 0–2 crew", version: "v1", scoreKind: "points",
    combos: [
    ...
    boardTree: [
      { id: "v1", label: "v1 (current)", combos: [
        { id: "rook-signal", label: "Rook · Rook Signal", play: "games/rook-signal/index.html", levels: [ { id: "rook-signal", label: "Chapter 1 — Resolve Score" } ] }
      ] }
    ] },
  { id: "arena-3d", name: "Proving Ground (3D wave arena)", status: "prototyping", text: "The first 3D game on the site \u2014 and the first real look at how one character FEELS to control. Drop into a walled pit in the Underweft, pick a crew member, and survive endless waves of husks coming through tears in the seam. Vesper is playable now: a three-hit blade chain, a two-charge Veilstep blink, and Execute \u2014 a finisher that kills anything already wounded, refunds a blink, and thins the floor where it lands. Stand perfectly still and the Shroud takes you: they lose track of you, and your next strike kills outright. Endless, with a named milestone wave every five.", chars: "Solo \u2014 one crew member per run", version: "v0", scoreKind: "points",
    combos: [
      { id: "proving-ground", label: "Vesper \u00b7 Proving Ground", sub: "3D wave survival \u00b7 blink, strike, execute", play: "games/proving-ground/index.html" }
    ],
    boardTree: [
      { id: "v0", label: "v0 (current)", combos: [
        { id: "vesper", label: "Vesper \u00b7 Phantom assassin", play: "games/proving-ground/index.html", levels: [ { id: "proving-ground", label: "Endless \u2014 run score" } ] }
      ] }
    ] },
